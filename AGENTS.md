...
### 状态卡强制更新
- **每次任务结束后必须更新 `docs/STATUS.md`**，反映最新的完成状态、测试计数、新问题
- 任何代码修改、Issue 关闭、里程碑交付后，立即更新状态卡  
  （包括：Milestone 进度、测试总数、GitHub Issues 表格、风险项）
- 不允许在连续两次行动之间 STATUS.md 处于过时状态
...
| 代码审查 / PR 审计 / 架构合规 / 门禁审计 | @代码审计员 | 代码质量把关，Gate 3 门禁审计 |
